...
handler.before = m => {
  ...
  if (user.afk > -1) {
    m.reply(`
*_Dejaste de estar inactivo (AFK)${user.afkReason ? ' después de estar inactivo (AFK) por el motivo: ' + user.afkReason : ''}_*

*_Tiempo de inactividad: ${clockString(new Date - user.afk)}_*
`.trim())
    user.afk = -1
    user.afkReason = ''
  }
