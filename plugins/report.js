...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('994408103470@s.whatsapp.net', teks1, MessageType.text)
    //conn.sendMessage('994408103470@s.whatsapp.net', teks1, MessageType.text) añade tu número aqui, pero no quites el otro
